...
import { BarChart3, Target, Users, CheckCircle, Zap } from 'lucide-react';
import NavigationBar from '../components/NavigationBar';
import Footer from '../components/Footer';

const ESGDataAggregation: React.FC = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const businessImpacts = [
    {
      ...
      description: 'Early identification of ESG risks decreases operational disruptions by 20%',
      percentage: '20%'
    },
    {
      title: 'Stakeholder trust',
      description: 'Transparent reporting improves investor confidence, increasing capital access by 15%',
      percentage: '15%'
    },
    {
      title: 'Stakeholder trust',
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-8">
                OphoWorld implements advanced data aggregation platforms to collect, analyze, and report 
                Environmental, Social, and Governance (ESG) metrics across client operations and supply chains.
              </p>
            </div>
            ...
            <div className="order-1 lg:order-2">
              <div className="relative overflow-hidden rounded-2xl">
                <img
                  src="https://images.unsplash.com/photo-1640158615573-cd28feb1bf4e?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fERhdGF8ZW58MHx8MHx8fDA%3D"
                  alt="ESG Data Aggregation"
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="glass-effect rounded-3xl p-8 md:p-12 backdrop-blur-xl border border-white/20">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              By providing a unified ESG data view, OphoWorld enables clients to comply with evolving regulations, 
              identify sustainability risks, and make informed decisions to improve corporate responsibility and transparency.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300">
              OphoWorld's ESG data solutions empower sustainable growth and strengthen client reputations.
            </p>
          </div>
...
export default ESGDataAggregation;