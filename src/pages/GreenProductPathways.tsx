...
import { Leaf, Target, Users, CheckCircle, Zap } from 'lucide-react';
import NavigationBar from '../components/NavigationBar';
import Footer from '../components/Footer';

const GreenProductPathways: React.FC = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const businessImpacts = [
    {
      ...
      description: 'Clients lower product carbon footprints by 25% on average',
      percentage: '25%'
    },
    {
      title: 'Market growth',
      description: 'Green products contribute to 30% revenue growth in emerging eco-conscious markets',
      percentage: '30%'
    },
    {
      title: 'Cost savings',
      description: 'Sustainable sourcing and design reduce material costs by 15%',
      percentage: '15%'
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-8">
                OphoWorld guides clients in designing and transitioning to green product development pathways, 
                integrating lifecycle assessments, eco-design principles, and sustainable materials sourcing.
              </p>
            </div>
            ...
            <div className="order-1 lg:order-2">
              <div className="relative overflow-hidden rounded-2xl">
                <img
                  src="https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8Z3JlZW4lMjBwcm9kdWN0fGVufDB8fDB8fHww"
                  alt="Green Product Pathways"
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="glass-effect rounded-3xl p-8 md:p-12 backdrop-blur-xl border border-white/20">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              This approach helps clients reduce environmental footprints, meet consumer demand for sustainable 
              products, and unlock new market segments with eco-friendly offerings.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300">
              OphoWorld's green product pathways enable competitive advantage through sustainability leadership.
            </p>
          </div>
...
export default GreenProductPathways;