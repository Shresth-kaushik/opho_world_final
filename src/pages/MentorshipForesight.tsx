...
const MentorshipForesight: React.FC = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              <div className="relative overflow-hidden rounded-2xl">
                <img
                  src="https://images.unsplash.com/photo-1512238972088-8acb84db0771?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8TWVudG9yc2hpcHxlbnwwfHwwfHx8MA%3D%3D"
...
export default MentorshipForesight;