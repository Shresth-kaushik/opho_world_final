...
const CrossBUKnowledgeExchange: React.FC = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const businessImpacts = [
    {
      ...
      description: '40% more leaders are prepared to lead transformational initiatives',
      percentage: '40%'
    },
    {
      title: 'Strategic agility',
      description: 'Mentored leaders improve decision-making speed by 35% in volatile environments',
      percentage: '35%'
    },
    {
      title: 'Retention boost',
      description: 'Mentorship programs reduce leadership turnover by 20%',
      percentage: '20%'
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-8">
                OphoWorld designs mentorship programs integrating strategic foresight tools to develop future-ready 
                leaders equipped to anticipate market shifts and lead innovation.
              </p>
            </div>
            ...
            <div className="order-1 lg:order-2">
              <div className="relative overflow-hidden rounded-2xl">
                <img
                  src="https://plus.unsplash.com/premium_photo-1675883156911-6496b36c9f4d?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Q3Jvc3MlMjBCVSUyMGtub3dsZWRnZSUyMCUyMGV4Y2hhbmdlfGVufDB8fDB8fHww"
                  alt="Mentorship + Strategic Foresight Development"
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="glass-effect rounded-3xl p-8 md:p-12 backdrop-blur-xl border border-white/20">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              By combining personalized mentorship with foresight analytics, OphoWorld builds leadership pipelines 
              capable of agile decision-making and visionary strategy formulation, securing long-term organizational success.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300">
              OphoWorld's leadership enablement cultivates resilient, forward-thinking leaders who steer business growth.
            </p>
          </div>
...
export default CrossBUKnowledgeExchange