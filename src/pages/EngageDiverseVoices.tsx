...
import { MessageCircle, Target, Users, CheckCircle, Zap } from 'lucide-react';
import NavigationBar from '../components/NavigationBar';
import Footer from '../components/Footer';

const EngageDiverseVoices: React.FC = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const businessImpacts = [
    {
      ...
      description: '30% higher adoption rates through iterative feedback incorporation',
      percentage: '30%'
    },
    {
      title: 'Reduced churn',
      description: 'Enhanced customer engagement leads to a 20% reduction in attrition',
      percentage: '20%'
    },
    {
      title: 'Accelerated innovation',
      description: 'Feedback-driven development cycles shorten time-to-market by 25%',
      percentage: '25%'
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-8">
                OphoWorld deploys multi-channel feedback systems—surveys, social listening, AI-powered 
                sentiment analysis—to capture diverse customer voices, preferences, and pain points at scale.
              </p>
            </div>
            ...
            <div className="order-1 lg:order-2">
              <div className="relative overflow-hidden rounded-2xl">
                <img
                  src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8Y3VzdG9tZXIlMjBmZWVkYmFja3xlbnwwfHwwfHx8MA%3D%3D"
                  alt="Engage Diverse Voices & User Feedback"
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="glass-effect rounded-3xl p-8 md:p-12 backdrop-blur-xl border border-white/20">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              By aggregating rich, real-time user data, OphoWorld enables clients to make informed product and 
              service improvements, align marketing strategies, and foster customer-centric innovation, increasing 
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300">
              OphoWorld's comprehensive feedback integration drives deeper customer insights that translate to 
...
export default EngageDiverseVoices;