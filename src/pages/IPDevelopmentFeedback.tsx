...
import { Award, Target, Users, CheckCircle, Zap } from 'lucide-react';
import NavigationBar from '../components/NavigationBar';
import Footer from '../components/Footer';

const IPDevelopmentFeedback: React.FC = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  const businessImpacts = [
    {
      title: 'Stronger IP portfolios',
      description: 'Continuous refinement leads to 30% more market-relevant patents',
      percentage: '30%'
    },
    {
      title: 'Risk mitigation',
      description: 'Proactive IP management reduces infringement incidents by 25%',
      percentage: '25%'
    },
    {
      title: 'Revenue generation',
      description: 'Enhanced IP monetization contributes to a 15% increase in licensing revenues',
      percentage: '15%'
    }
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <p className="text-lg md:text-xl text-gray-300 leading-relaxed mb-8">
                OphoWorld integrates continuous feedback mechanisms into its IP development process to iteratively 
                refine innovations and protect client interests with dynamic patent and IP strategies.
              </p>
            </div>
            ...
            <div className="order-1 lg:order-2">
              <div className="relative overflow-hidden rounded-2xl">
                <img
                  src="https://images.unsplash.com/photo-1554306274-f23873d9a26c?w=900&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fElQJTIwRGV2ZWxvcG1lbnR8ZW58MHx8MHx8fDA%3D"
                  alt="IP Development & Innovation Loop Feedback"
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="glass-effect rounded-3xl p-8 md:p-12 backdrop-blur-xl border border-white/20">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              Ongoing innovation loop feedback helps clients adapt IP portfolios proactively, maximizing commercial 
              value while mitigating infringement risks in fast-evolving markets.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-300">
              OphoWorld's innovation loop ensures clients maintain sustainable IP leadership and competitive 
              differentiation.
            </p>
          </div>
...
export default IPDevelopmentFeedback;